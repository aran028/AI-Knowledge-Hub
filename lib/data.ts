...
export const playlists: Playlist[] = [
  { id: "nlp", name: "NLP", icon: "brain", count: 12 },
  { id: "computer-vision", name: "Computer Vision", icon: "eye", count: 8 },
  { id: "sewing", name: "Sewing", icon: "scissors", count: 5 },
  { id: "deep-learning", name: "Deep Learning", icon: "layers", count: 15 },
  { id: "robotics", name: "Robotics", icon: "bot", count: 7 },
  { id: "data-science", name: "Data Science", icon: "bar-chart", count: 10 },
  { id: "generative-ai", name: "Generative AI", icon: "sparkles", count: 9 },
  { id: "reinforcement-learning", name: "Reinforcement Learning", icon: "gamepad", count: 6 },
]
